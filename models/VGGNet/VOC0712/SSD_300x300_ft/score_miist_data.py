...
#train_data = "data/coco/train.lmdb"
train_data = "data/miist/miistDataset/test.lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "data/miist/test.lmdb"
#test_data = "/home/nsauca/data/VOCdevkit/VOC0712/lmdb/VOC0712_test_lmdb"
...
#name_size_file = "/home/nsauca/caffe/data/coco/test_name_size.txt"
name_size_file = "/home/nsauca/caffe/data/miist/test_name_size.txt"
#name_size_file = "data/VOC0712/test_name_size.txt"
# The resume model.
#pretrain_model = "models/VGGNet/VOC0712/SSD_300x300_ft/VGG_VOC0712Plus_SSD_300x300_ft_iter_160000.caffemodel"
pretrain_model = "models/VGGNet/VOC0712/SSD_300x300_ft/VGG_VOC0712_SSD_300x300_ft_iter_450000.caffemodelBEST"
# Stores LabelMapItem.
...
with open(job_file, 'w') as f:
  ...
  if solver_param['solver_mode'] == P.Solver.GPU:
    f.write('--gpu {} 2>&1 | tee {}/{}_test{}.log\n'.format(gpus, job_dir, model_name, 160000))
  else:
