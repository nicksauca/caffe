...
savePath = '/home/nsauca/results/ssd/congestedOutput'
annotationFile = open(savePath+'/notCongested.txt', "w")
os.chdir(path)
...
#    currentAxis = plt.gca()
    for i in xrange(top_conf.shape[0]):
        ...
        annotationFile.write(file+' '+label_name+' '+str(xmin)+' '+str(ymin)+' '+str(xmax)+' '+str(ymax)+' '+str(score)+'\n')
